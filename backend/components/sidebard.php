<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        ...
                        <li>
                            <a class="nav-link d-flex align-items-center gap-2" href="./add_company.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./company_all.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./company_suspend.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-buildings" viewBox="0 0 16 16">
                                    <path d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022ZM6 8.694 1 10.36V15h5V8.694ZM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15Z" />
                                    <path d="M2 11h1v1H2v-1Zm2 0h1v1H4v-1Zm-2 2h1v1H2v-1Zm2 0h1v1H4v-1Zm4-4h1v1H8V9Zm2 0h1v1h-1V9Zm-2 2h1v1H8v-1Zm2 0h1v1h-1v-1Zm2-2h1v1h-1V9Zm0 2h1v1h-1v-1ZM8 7h1v1H8V7Zm2 0h1v1h-1V7Zm2 0h1v1h-1V7ZM8 5h1v1H8V5Zm2 0h1v1h-1V5Zm2 0h1v1h-1V5Zm0-2h1v1h-1V3Z" />
                                </svg>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./company_block.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-buildings" viewBox="0 0 16 16">
                                    <path d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022ZM6 8.694 1 10.36V15h5V8.694ZM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15Z" />
                                    <path d="M2 11h1v1H2v-1Zm2 0h1v1H4v-1Zm-2 2h1v1H2v-1Zm2 0h1v1H4v-1Zm4-4h1v1H8V9Zm2 0h1v1h-1V9Zm-2 2h1v1H8v-1Zm2 0h1v1h-1v-1Zm2-2h1v1h-1V9Zm0 2h1v1h-1v-1ZM8 7h1v1H8V7Zm2 0h1v1h-1V7Zm2 0h1v1h-1V7ZM8 5h1v1H8V5Zm2 0h1v1h-1V5Zm2 0h1v1h-1V5Zm0-2h1v1h-1V3Z" />
                                </svg>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./add_foreign_company.php">
                                <svg width="13px" height="13px" viewBox="0 0 42.989 42.989" xmlns="http://www.w3.org/2000/svg">
                                    <path id="add" d="M631.793,354.3a3.1,3.1,0,0,1-2.491,2.491,133.9,133.9,0,0,1-35.627,0,3.1,3.1,0,0,1-2.491-2.491,133.9,133.9,0,0,1,0-35.627,3.1,3.1,0,0,1,2.491-2.491,133.9,133.9,0,0,1,35.627,0,3.1,3.1,0,0,1,2.491,2.491A133.9,133.9,0,0,1,631.793,354.3Zm-5.884-19.141c-3.97-.29-7.939-.43-11.909-.474-.031-4.206-.18-8.412-.487-12.619a1.311,1.311,0,0,0-2.622,0c-.307,4.2-.455,8.4-.487,12.606-4.2.032-8.4.18-12.606.487a1.312,1.312,0,0,0,0,2.622c4.206.307,8.412.456,12.619.487.044,3.97.184,7.939.474,11.909a1.311,1.311,0,0,0,2.622,0c.29-3.974.43-7.948.475-11.922,3.974-.044,7.948-.184,11.922-.474a1.312,1.312,0,0,0,0-2.622Z" transform="translate(-589.994 -314.994)" fill="#2d5be2" />
                                </svg>
                                بهرنی شرکت ثبتول
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./company_all_foreign.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-buildings" viewBox="0 0 16 16">
                                    <path d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022ZM6 8.694 1 10.36V15h5V8.694ZM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15Z" />
                                    <path d="M2 11h1v1H2v-1Zm2 0h1v1H4v-1Zm-2 2h1v1H2v-1Zm2 0h1v1H4v-1Zm4-4h1v1H8V9Zm2 0h1v1h-1V9Zm-2 2h1v1H8v-1Zm2 0h1v1h-1v-1Zm2-2h1v1h-1V9Zm0 2h1v1h-1v-1ZM8 7h1v1H8V7Zm2 0h1v1h-1V7Zm2 0h1v1h-1V7ZM8 5h1v1H8V5Zm2 0h1v1h-1V5Zm2 0h1v1h-1V5Zm0-2h1v1h-1V3Z" />
                                </svg>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./company_block_foreign.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-buildings" viewBox="0 0 16 16">
                                    <path d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022ZM6 8.694 1 10.36V15h5V8.694ZM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15Z" />
                                    <path d="M2 11h1v1H2v-1Zm2 0h1v1H4v-1Zm-2 2h1v1H2v-1Zm2 0h1v1H4v-1Zm4-4h1v1H8V9Zm2 0h1v1h-1V9Zm-2 2h1v1H8v-1Zm2 0h1v1h-1v-1Zm2-2h1v1h-1V9Zm0 2h1v1h-1v-1ZM8 7h1v1H8V7Zm2 0h1v1h-1V7Zm2 0h1v1h-1V7ZM8 5h1v1H8V5Zm2 0h1v1h-1V5Zm2 0h1v1h-1V5Zm0-2h1v1h-1V3Z" />
                                </svg>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class=" accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <li class="nav-item bd-links-heading">
                            <a class="nav-link d-flex align-items-center gap-2 bd-links-link d-inline-block rounded" href="./contract.php">
                                <svg class="bi">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center dropdown-item gap-2" href="./contract_all.php">
                                <svg class="bi">
                                    <use xlink:href="#file-earmark-text" />
                                </svg>
                                ټول قراردادونه
        ...
        <ul class="nav flex-column">
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./daily_forms.php">
                                <svg class="bi">
                                    <use xlink:href="#file-earmark-text" />
                                </svg>
                                ورځنی ډکې شوې فورمې
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./report_day.php">
                                <svg class="bi">
                                    <use xlink:href="#file-earmark-text" />
                                </svg>
                                ورځنی راپور
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./report_week.php">
                                <svg class="bi">
                                    <use xlink:href="#file-earmark-text" />
                                </svg>
                                اونیز راپور
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./report_month.php">
                                <svg class="bi">
                                    <use xlink:href="#file-earmark-text" />
                                </svg>
                                میاشتنی راپور
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="./report_year.php">
                                <svg class="bi">
                                    <use xlink:href="#file-earmark-text" />
                                </svg>
                                کلنی راپور
    ...
    <ul class="nav flex-column mb-auto">
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center mx-4 px-1 gap-2" href="./../../logout.php">
                <svg class="bi">
