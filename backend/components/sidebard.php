<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2" href="./backend.php">
                <svg class="bi">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2" href="./contract.php">
                <svg class="bi">
        ...
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2" href="./contract_all.php">
                <svg class="bi">
                    <use xlink:href="#file-earmark-text" />
                </svg>
                ټول قراردادونه
