...
$query = "SELECT * FROM `companies` where suspend = 1 ";
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"> ځنډول شوي داخلي شرکتونه</h1>
                </div>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($data as $value) { ?>
                                                            <tr style="border: 1px solid lightgray">
                                                                <td style="border: 1px solid lightgray"><?php echo $value[0] ?></td>
                                                                ...
                                                                <td scope="col-2" style="border-left: 1px solid lightgray">
                                                                    <a href="./company_details_suspend.php?id=<?php echo $value[0] ?>">
