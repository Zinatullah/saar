                    ...
                    <div class="col-md-7 col-lg-12 col-md-12 p-3">
                        <form action="./forms/daily_form.php" method="post" enctype="multipart/form-data">
                            <div class="row g-3 my-3">
                                ...
                                <div class="col-sm-4">
                                    <label class="form-label">د شرکت خرید في ټن</label>
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-12">
                                        <span style="position: relative; top:12px; font-size: 18px;" class="p-2 badge text-bg-warning">دغه برخه تاسو ډکه کړئ</span>
                                    </div>
