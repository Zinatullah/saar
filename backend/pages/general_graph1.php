...
if(isset($_POST['submit'])){
    ...
    $query = "SELECT port, type, sum($type1) FROM daily_form WHERE port IN ('$valueList') and type = '$type' group by port";
...
<body style="font-family: calibri !important;">
    ...
    <script>
        ...
        (function() {
            $.ajax({
                url: "graph/create_graph.php", // PHP file that retrieves the data
                type: "GET",
                dataType: "json",
