                        ...
                        <form method="POST" enctype="multipart/form-data" action="./companies/add_company_foreign.php">
                            <div class="row g-3 my-5">
                                <h4 class="text-center">
                                    <span class="badge p-3 rounded-pill text-bg-success"> د بهرني شرکت په هکله معلومات په دغه فورم کې ولیکئ
                                    </span>
                                </h4>
                                <div class="col-sm-12">
                                    <div class="col-sm-4">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="name" placeholder="د قراردادي شرکت نوم" value="" required="">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="address" placeholder="آدرس" value="" required="">
                                </div>

                                <div class="col-sm-6">
                                    <input type="number" class="form-control" style="text-align: right;" name="phone" placeholder="د تلیفون نمبر" value="" required="">
                                </div>
                                <div class="col-sm-6">
                                    <input type="email" class="form-control" style="text-align: right;" name="email" placeholder="ایمیل آدرس" value="" required="">
                                </div>

                                <div class="col-sm-6">
                                    <input type="number" class="form-control" style="text-align: right;" name="license" placeholder="د جواز نمبر" value="" required="">
                                </div>

                                <div class="col-sm-6">
                                    <input type="text" class="form-control" style="text-align: right;" name="country" placeholder="د هېواد نوم" value="" required="">
                                </div>

                                <div class="col-sm-6">
                                    <input type="file" class="form-control" name="license_copy" placeholder="د جواز کافي" value="" required="">
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="ceo" placeholder="د مالک نوم" value="" required="">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="ceo_phone" placeholder="د مالک نمبر" value="" required="">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="dep" placeholder="د معاون نوم" value="" required="">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="dep_phone" placeholder="د معاون نمبر" value="" required="">
                                </div>
