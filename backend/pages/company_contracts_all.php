...
$query = "SELECT * FROM `contracts` where company = '$country'";
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left;">
                                            <form action="./contracts/contract_remove.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="remove1" value="<?php echo $element[0] ?>">
                                                <input type="hidden" name="company" value="<?php echo $element[1] ?>">
                                                <button name="delete" type="submit" class="btn btn-sm ">
                                            ...
                                            <span>
                                                <a href="./contract_details.php?id=<?php echo $element[0] ?>">
                                                    <button type="button" class="btn btn-success btn-sm">جزئیات</button>
                                                </a>
                                            </span>
                                        </td>
                                        <td></td>
